...
$k=1;
	...
	$m=1;
	do { if($m==$n) {printf( "<p align=left><a style='margin-left:30px; background-color:grey; color:white; text-decoration: none;' href='auto_min.php?i=1&j=$k&l=$m'>%s</a></p>",$row2["razr"]);} else {
